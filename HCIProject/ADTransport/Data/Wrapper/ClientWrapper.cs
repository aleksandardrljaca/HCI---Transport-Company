...
namespace ADTransport.Data.Wrapper
{
    public class ClientWrapper
    {
        ...
        private static readonly string UPDATE_CLIENT = @"UPDATE klijent SET klijent.Ime=@Ime,klijent.Kontakt=@Kontakt WHERE klijent.IDKlijenta=@Id";
        ...
        public static bool UpdateClient(int id,string name, string contact)
        {
            MySqlConnection conn = null;
            MySqlCommand cmd = null;
            try
